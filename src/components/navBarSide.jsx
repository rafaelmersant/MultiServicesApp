...
const NavBarSide = ({ user }) => {
  ...
  return (
    <div className="border-right" id="sidebar-wrapper">
      <div className="sidebar-heading text-center" style={{background: "white"}}>
        <div>
          <img
            style={{ width: "54px", padding: "5px", margin: "0" }}
            src={process.env.PUBLIC_URL + "/images/CASAMINAYA_small.png"}
            alt="CASA MINAYA"
          />
        </div>
      </div>
      <div className="list-group list-group-flush">
        {user &&
          (user.role === "Admin" ||
            ...
            <React.Fragment>
              <NavLink
                className="list-group-item list-group-item-action text-dark border-none py-2"
                to="/invoice/new"
              >
